        ...
        <div class="site-section py-0">
            <client-only>
                <carousel
                    :items="1"
                    :autoplay="true"
                    class="hero-slide owl-style"
                >
                    <div class="site-section">
                        <div class="container">
                            <div
                                class="half-post-entry d-block d-lg-flex bg-light"
                            >
                                <div
                                    class="img-bg"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="post-entry-2 d-flex">
                                    <div
                                        class="thumbnail"
                                        style="background-image: url('images/img_v_2.jpg')"
                                    ></div>
                                    <div class="contents">
                                        <h2>
                                            <a href="blog-single.html"
                                ...
                                <div class="post-entry-2 d-flex">
                                    <div
                                        class="thumbnail"
                                        style="background-image: url('images/img_v_3.jpg')"
                                    ></div>
                                    <div class="contents">
                                        <h2>
                                            <a href="blog-single.html"
                ...
                <div class="half-post-entry d-block d-lg-flex bg-light">
                    ...
                    <div class="contents">
                        ...
                        <p class="mb-3">
                            ...
                            Enim praesentium magni delectus cum, tempore
                            deserunt aliquid quaerat culpa nemo veritatis, iste
                            adipisci excepturi consectetur doloribus aliquam
                            accusantium beatae?
                        </p>
                        ...
                        <div class="post-meta">
                            ...
                            >
                            <span class="date-read"
                                >Jun 14 <span class="mx-1">&bullet;</span> 3 min
                                read <span class="icon-star2"></span
                            ></span>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-9">
                        ...
                        <div class="post-entry-2 d-flex">
                            <div
                                ...
                                style="background-image: url('images/img_h_4.jpg')"
                            ></div>
                        ...
                        <div class="post-entry-2 d-flex">
                            <div
                                class="thumbnail order-md-2"
                                style="background-image: url('images/img_h_3.jpg')"
                            ></div>
                            <div class="contents order-md-1 pl-0">
                                <h2>
                                    <a href="blog-single.html"
                        ...
                        <div class="post-entry-2 d-flex">
                            ...
                            ></div>
                            <div class="contents order-md-1 pl-0">
                                <span class="caption mb-4 d-block"
                                    >Editor's Pick</span
                                >
                                <h2>
                                    <a href="blog-single.html"
                    ...
                    <div class="col-12">
                        <div class="copyright">
                            <p>
                                ...
                                <a
                                    href="https://vidath.weerasi.com/"
                                    target="_blank"
                                    >Don Vidath M Weerasinghe</a
                                >
                            </p>
                        </div>
                    </div>
